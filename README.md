...
This method uses two queues: push in O(n) and pop in O(1). The newly inserted element is kept at the front of quue q1 for easy access. Queue q2 is used to rearrange the elements during push().
